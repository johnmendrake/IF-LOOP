...
public class Graph {
	...
	/**
	 * Ein Objekt vom Typ Graph wird erstellt. Der von diesem Objekt repraesentierte
	 * Graph ist leer.
	 */
	public Graph() {
	 ...
	 * noch keine Kante zwischen den Knoten existiert. Ansonsten passiert nichts.
	 */
	 ...
	 * List<Vertex>. Hat der Knoten pVertex keine Nachbarn in diesem Graphen oder
	 ...
	 * pAnotherVertex nicht im Graphen enthalten oder gibt es keine Kante, die beide
